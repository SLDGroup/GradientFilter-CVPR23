...
python trainer_cls.py --config configs/cls/mcunet/filt_last1_r2.yaml ${common_args} --logger.exp_name filt_l1_r2_${usr_group_kl} --model.with_grad_filter True
python trainer_cls.py --config configs/cls/mcunet/filt_last2_r2.yaml ${common_args} --logger.exp_name filt_l2_r2_${usr_group_kl} --model.with_grad_filter True
python trainer_cls.py --config configs/cls/mcunet/filt_last3_r2.yaml ${common_args} --logger.exp_name filt_l3_r2_${usr_group_kl} --model.with_grad_filter True
python trainer_cls.py --config configs/cls/mcunet/filt_last4_r2.yaml ${common_args} --logger.exp_name filt_l4_r2_${usr_group_kl} --model.with_grad_filter True
