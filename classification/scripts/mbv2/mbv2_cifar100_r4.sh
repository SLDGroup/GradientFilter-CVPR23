...
python trainer_cls.py --config configs/cls/mbv2/filt_last1_r4.yaml ${common_args} --logger.exp_name filt_l1_r4_${usr_group_kl} --model.with_grad_filter True
python trainer_cls.py --config configs/cls/mbv2/filt_last2_r4.yaml ${common_args} --logger.exp_name filt_l2_r4_${usr_group_kl} --model.with_grad_filter True
python trainer_cls.py --config configs/cls/mbv2/filt_last3_r4.yaml ${common_args} --logger.exp_name filt_l3_r4_${usr_group_kl} --model.with_grad_filter True
python trainer_cls.py --config configs/cls/mbv2/filt_last4_r4.yaml ${common_args} --logger.exp_name filt_l4_r4_${usr_group_kl} --model.with_grad_filter True
