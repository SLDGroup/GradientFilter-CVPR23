...
python trainer_cls.py --config configs/cls/res34/filt_last1_r2.yaml ${common_args} --logger.exp_name base_l1_${usr_group_kl} --model.with_grad_filter False
python trainer_cls.py --config configs/cls/res34/filt_last2_r2.yaml ${common_args} --logger.exp_name base_l2_${usr_group_kl} --model.with_grad_filter False
python trainer_cls.py --config configs/cls/res34/filt_last3_r2.yaml ${common_args} --logger.exp_name base_l3_${usr_group_kl} --model.with_grad_filter False
python trainer_cls.py --config configs/cls/res34/filt_last4_r2.yaml ${common_args} --logger.exp_name base_l4_${usr_group_kl} --model.with_grad_filter False
