...
gradient_filter = dict(
    ...
    filter_install=[
        ...
        dict(path="decode_head.lateral_convs.0", type='cbr', radius=8),
        dict(path="decode_head.lateral_convs.1", type='cbr', radius=4),
        dict(path="decode_head.lateral_convs.2", type='cbr', radius=2),
